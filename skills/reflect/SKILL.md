...
- Substantive existing-skill edit (a new section, a new pattern table, more than ~10 lines): hand to the current harness's built-in `create-skill` skill and run its draft / test / iterate loop.
