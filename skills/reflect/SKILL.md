...
- Substantive existing-skill edit (a new section, a new pattern table, more than ~10 lines): hand to the repository's skill-authoring workflow and run its draft / test / iterate loop.
