...
4. Pick the worker model from the active mstack model configuration's `implementer` role, defaulting to `inherit-parent`. For a model race, name each arm's model up front.
